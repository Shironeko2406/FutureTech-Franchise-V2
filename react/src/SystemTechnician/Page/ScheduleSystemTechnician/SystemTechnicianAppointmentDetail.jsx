...
const SystemTechnicianAppointmentDetail = () => {
    ...
    useEffect(() => {
        if (!selectedAppointment) {
            navigate('/ScheduleSystemTechnician');
        }
            ...
            {!isFutureAppointment && !isReportAvailable && (
                ...
                >
                    <Form form={form} onFinish={onFinish} layout="vertical">
                        <Form.Item name="report" label="Nội dung báo cáo" initialValue={report}>
                            <Input.TextArea rows={4} />
                        </Form.Item>
                        <Form.Item name="reportImageURL" label="URL báo cáo" initialValue={reportImageURL}>
                            <Input prefix={<FilePdfOutlined />} />
                        </Form.Item>
                        <Form.Item name="status" label="Trạng thái" initialValue={status}>
                            <Select>
