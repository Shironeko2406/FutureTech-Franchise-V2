...
const StudentAccountManagement = () => {
    ...
    useEffect(() => {
        setLoading(true);
        dispatch(GetAccountsActionAsync(search, isActive, "Student", pageIndex, pageSize))
    ...
    return (
        <div className="card">
            <div className="card-body">
                <h5 className="card-title mb-3">Quản Lý Tài Khoản Học Sinh</h5>
                ...
                <Table
                    ...
                    pagination={{
                        showTotal: () => `Tổng số học sinh: ${totalItemsCount}`,
                        current: pageIndex,
                        pageSize,
