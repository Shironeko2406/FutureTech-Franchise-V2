...
import './SystemInstructorAppointment.css';
import { useNavigate } from 'react-router-dom';

moment.locale('vi'); // Set moment locale to Vietnamese
const localizer = momentLocalizer(moment);

const SystemInstructorAppointment = () => {
    ...
    const events = appointmentSchedules.map(instructor => ({
        id: instructor.id,
        title: `${instructor.title}`,
        start: new Date(instructor.startTime),
        end: new Date(instructor.endTime),
...
export default SystemInstructorAppointment;